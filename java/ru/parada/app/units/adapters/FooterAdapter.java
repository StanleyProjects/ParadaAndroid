...
public abstract class FooterAdapter<MODELHOLDER extends RecyclerView.ViewHolder, MODEL, LISTENER>
        extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    private Context context;
    private LISTENER listener;

    public FooterAdapter(Context c, LISTENER l)
    {
        this.context = c;
        this.listener = l;
    }
    ...
    {
        if(getItemViewType(position) == ViewTypes.FOOTER)
        {
            setFooter(holder);
        }
        else
        {
            setData((MODELHOLDER)holder, getItem(position));
        }
    }
